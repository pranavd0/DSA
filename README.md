...
> Automatically synced via **LeetSync** (`leetcode/`), **CodeSync** (`Geeks For Geeks/`), and **GitHub Actions**.
...
## 🌟 Additional Solved Problems (Outside the Sheet)

| Platform | Problem | Solution |
| :---: | :--- | :--- |
| **LeetCode** | [Maximum Number of Vowels in a Substring of Given Length](https://leetcode.com/problems/maximum-number-of-vowels-in-a-substring-of-given-length/) | [Solution](leetcode/1567-maximum-number-of-vowels-in-a-substring-of-given-length) |
| **LeetCode** | [Happy Number](https://leetcode.com/problems/happy-number/) | [Solution](leetcode/202-happy-number) |
| **LeetCode** | [Remove Linked List Elements](https://leetcode.com/problems/remove-linked-list-elements/) | [Solution](leetcode/203-remove-linked-list-elements) |
| **LeetCode** | [Zigzag Conversion](https://leetcode.com/problems/zigzag-conversion/) | [Solution](leetcode/6-zigzag-conversion) |
| **LeetCode** | [Maximum Average Subarray I](https://leetcode.com/problems/maximum-average-subarray-i/) | [Solution](leetcode/643-maximum-average-subarray-i) |
| **LeetCode** | [Find Pivot Index](https://leetcode.com/problems/find-pivot-index/) | [Solution](leetcode/724-find-pivot-index) |
| **LeetCode** | [Daily Temperatures](https://leetcode.com/problems/daily-temperatures/) | [Solution](leetcode/739-daily-temperatures) |
| **LeetCode** | [Subsets](https://leetcode.com/problems/subsets/) | [Solution](leetcode/78-subsets) |
| **LeetCode** | [Remove Duplicates from Sorted List](https://leetcode.com/problems/remove-duplicates-from-sorted-list/) | [Solution](leetcode/83-remove-duplicates-from-sorted-list) |
| **LeetCode** | [Advantage Shuffle](https://leetcode.com/problems/advantage-shuffle/) | [Solution](leetcode/901-advantage-shuffle) |
| **LeetCode** | [Middle of the Linked List](https://leetcode.com/problems/middle-of-the-linked-list/) | [Solution](leetcode/908-middle-of-the-linked-list) |
